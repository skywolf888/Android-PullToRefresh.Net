...
namespace Com.Handmark.PullToRefresh.Library
{
    public interface IPullToRefresh<T> where T : View
    {
         ...
         * 
         * @return bool - true if the View is filtering Touch Events
         */
        bool getFilterTouchEvents();
         ...
         */
        bool getShowViewWhileRefreshing();
         ...
         */
        bool isPullToRefreshOverScrollEnabled();
         ...
         */
        bool isScrollingWhileRefreshingEnabled();
         ...
         *            true.
         */
        void setFilterTouchEvents(bool filterEvents);
         ...
         */
        void setPullToRefreshOverScrollEnabled(bool enabled);
         ...
         *            view.
         */
        void setRefreshing(bool doScroll);
         ...
         */
        void setScrollAnimationInterpolator(IInterpolator interpolator);
         ...
         */
        void setScrollingWhileRefreshingEnabled(bool scrollingWhileRefreshingEnabled);
