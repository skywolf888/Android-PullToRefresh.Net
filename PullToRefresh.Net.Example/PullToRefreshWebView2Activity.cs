...
{
    [Activity(Label = "PullToRefreshWebView2Activity")]
    public sealed class PullToRefreshWebView2Activity : Activity, OnRefreshListener<WebView>
    {
        ...
        private static class SampleWebViewClient : WebViewClient
        {
            //@Override
